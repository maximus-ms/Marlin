...
#define STRING_CONFIG_H_AUTHOR "Max" // Who made the changes.
 ...
 */
#define SERIAL_PORT_2 2   // USART2 for ESP3D (STM32G0: check board pinout for TX2/RX2 pins)
#define BAUDRATE_2 250000 // Must match ESP3D serial baud (115200 or 250000)
...
#define CUSTOM_MACHINE_NAME "Max3D"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 195.00
  #define DEFAULT_BED_KI 37.43
  #define DEFAULT_BED_KD 674.8
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 405 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3500, 3500, 50, 5000 }
...
#define XY_AFTER_HOMING { 3, Y_BED_SIZE-3 }  // (mm) Move to an XY position after homing (and raising Z)
...
#define EVENT_GCODE_AFTER_G29 "G1 Z0.5\n G1 X15 Y15"
/**
...
// #define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 25  // (mm) X point for Z homing
  //#define Z_SAFE_HOMING_Y_POINT Y_CENTER  // (mm) Y point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 25  // (mm) Y point for Z homing
